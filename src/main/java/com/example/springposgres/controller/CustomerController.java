...
public class CustomerController {
	...
	public String bulkcreate(){
		repository.save(new Customer("Dmytro", "Kasiianenko"));
		
        repository.saveAll(Arrays.asList(new Customer("Maks", "Butko")
                       , new Customer("Taras", "Shevchenko")
                       , new Customer("Mariia", "Miroshnyk")
                       , new Customer("Olena", "Kasiianenko")));
